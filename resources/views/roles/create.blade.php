...
<div class="page-header">
    <h3 class="fw-bold mb-3">Créer un Rôle</h3>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Ajouter un Nouveau Rôle</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    {{-- Guard Name - Add if needed, Spatie usually defaults to 'web'
                    <div class="form-group">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        @foreach ($modulePermissions as $permission)
                                            <div class="form-check">
                                                <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission-{{ $permission->id }}" class="form-check-input @error('permissions') is-invalid @enderror" {{ (is_array(old('permissions')) && in_array($permission->id, old('permissions'))) ? 'checked' : '' }}>
                    ...
                    <div class="card-action mt-3">
                        <button type="submit" class="btn btn-success">
                            <i class="fa fa-save"></i> Créer le Rôle
                        </button>
